...
error_reporting(0);
ob_start();
$API_KEY = '1339306908:AAG_jZZlW0nqGDt9mkDrchlJ0hzgG72UqQA';
	...
	bot('answerInlineQuery',[
        ...
        'results' => json_encode([[
            ...
            [
                ...
                ['text' => "👎 [".$dis ."]", 'callback_data' => "paslike&--&$inlineqt"],
            ]
        ]]
            ]])
        ]);
...
if ($data[0] == 'like') {
	...
	bot('editMessageReplyMarkup',[
            ...
            [
                ...
                ['text' => '👎 ['.$dis .']', 'callback_data' => "passlike&--&$data[1]"],
            ]
        ]
				])
			]);
...
if ($data[0] == 'dislike') {
	...
	bot('editMessageReplyMarkup',[
            ...
            [
                ['text' =>"👍 [".$lik."]", 'callback_data' => "like&--&$data[1]"],
                ['text' => '👎 ['.$dis .']', 'callback_data' => "paslike&--&$data[1]"],
            ]
        ]
				])
			]);
...
if($data[0] == 'out'){
    bot('editMessageText',[
		...
		'reply_markup'=>json_encode([
			'inline_keyboard'=>[
				[['text'=>'Like tuzish ⚡️ ','callback_data'=>'crPo']],
				[['text'=>'Yaratuvchi😎','url'=>'t.me/Hacker_Bey']]
			]
		])
		]);
        $msgs[$chat_id2] = null;
